...
@Controller
@RequestMapping(value = "/hotel/{hotelCode}/rooms")
public class RoomController {
	...
	public String submitRoom(Model model, @PathVariable String hotelCode, @ModelAttribute RoomData roomData) {
		logger.info("submitroom hotelCode:{}, number:{}, type:{}", hotelCode, roomData.getNumber(),
				roomData.getType());
		...
		return "redirect:/hotel/" + hotelCode + "/rooms";
	}
